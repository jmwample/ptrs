...
pub const CLIENT_MIN_PAD_LENGTH: usize = (SERVER_MIN_HANDSHAKE_LENGTH + INLINE_SEED_FRAME_LENGTH) - CLIENT_MIN_HANDSHAKE_LENGTH;
pub const CLIENT_MAX_PAD_LENGTH: usize = MAX_HANDSHAKE_LENGTH - CLIENT_MIN_HANDSHAKE_LENGTH;
pub const CLIENT_MIN_HANDSHAKE_LENGTH: usize = elligator2::REPRESENTATIVE_LENGTH + MARK_LENGTH + MAC_LENGTH;
   
pub const SERVER_MIN_PAD_LENGTH: usize = 0;
pub const SERVER_MAX_PAD_LENGTH: usize = MAX_HANDSHAKE_LENGTH - (SERVER_MIN_HANDSHAKE_LENGTH + INLINE_SEED_FRAME_LENGTH);
pub const SERVER_MIN_HANDSHAKE_LENGTH: usize = elligator2::REPRESENTATIVE_LENGTH + ntor::AUTH_LENGTH + MARK_LENGTH + MAC_LENGTH;

pub const INLINE_SEED_FRAME_LENGTH: usize =framing::FRAME_OVERHEAD + PACKET_OVERHEAD + SEED_PACKET_PAYLOAD_LENGTH;


pub const PACKET_OVERHEAD: usize = 2 + 1;
pub const MAX_PACKET_PAYLOAD_LENGTH: usize =
